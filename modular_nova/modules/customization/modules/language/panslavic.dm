/datum/language/spinwarder
	...
	and the Coalition followed suit, adopting it as the language of the Chamber of Legislation, the Unified High Command, and the Expeditionary \
	Police Force. Linguistically, Pan-Slavic retains the Slavic verbal aspect system (perfective vs. imperfective) and much of its foundational \
	vocabulary: body parts, family, nature, and basic actions. However, centuries of separation and the mixing of settlers from different \
	regional backgrounds simplified its noun morphology dramatically, reducing the complex Slavic case system to a two-case distinction (Nominative and Oblique). \
	Its default word order shifted from SVO to SOV under influence from the Central Asian linguistic heritage present among the colonists, \
	and fixed final-syllable stress replaced the mobile stress patterns of older Slavic languages. Today, Pan-Slavic is spoken natively by the human majority \
	of the CZD and as a second language by most other Coalition citizens. Its written form uses a 30-letter phonetic Latin alphabet, standardized in \
	the 24th century for compatibility with Coalition military and civilian systems. The 'Vistula Standard' dialect of Pan-Slavic is the prestige dialect \
	of Coalition administration, taught in schools across the Coalition and used in all official documents. While Sol Common remains the language of \
	interstellar communication, Pan-Slavic is the language of home, of the Chamber, and of the Long Arm. To an outsider, it sounds simultaneously \
	familiar and alien - recognizably Slavic in its rhythm and consonant clusters, but spoken with a steady final-syllable stress that flattens the \
	melodic rise and fall of its ancestral tongues, and punctuated by loanwords from the Turkic and Persian linguistic strata that survived the Quiet Century."
	key = "P"
