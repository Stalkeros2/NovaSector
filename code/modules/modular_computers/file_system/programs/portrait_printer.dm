...
/datum/computer_file/program/portrait_printer
	...
	extended_desc = "This program connects to a Nova Sector community art site for viewing and printing art, the latter only available on stationary consoles." // NOVA EDIT REMOVAL - Total Spinward Death
