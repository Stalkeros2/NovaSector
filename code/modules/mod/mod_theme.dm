...
/datum/mod_theme/syndicate
	name = "syndicate"
	desc = "A suit designed by Gorlex Marauders, offering armor ruled illegal in most of Nova Sector." // NOVA EDIT REMOVAL - Total Spinward Death. Spinward Stellar -> Nova Sector
