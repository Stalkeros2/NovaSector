...
/obj/item/ammo_casing/arrow/plastic
	name = "plastic arrow"
	desc = "The earliest mining teams within the Nova Sector were the somewhat stout ancestors of the modern settlers. These teams \
		...
		Left with few options, and in need of a way to protect themselves in the hostile work environments of the Nova, they turned \
		to the one material they had in abundance." // NOVA EDIT REMOVAL - Total Spinward Death.
