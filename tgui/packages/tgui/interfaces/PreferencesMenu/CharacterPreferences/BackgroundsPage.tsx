...
import { Box, Button, Divider, Stack, Tooltip } from '../../components';
import type { CultureFeature, PreferencesMenuData } from './data';

const BackgroundEntry = (props) => {
  const { background } = props;
  let lang_string: string = '';
  let not_first_iteration: boolean = false;
  for (const language_string in background.additional_langs) {
